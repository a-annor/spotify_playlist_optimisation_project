...
##SETUP
cid ='6bfdac771c2e4c84b9b9ed68e665b58c'
secret ='cc311eccd84342a29db39ce579a64e3b'
...
def encode_fields(playlist_data):
    ...
    ##Standard Scalar on continous features 
...
def create_ordered_playlist (creator, username, playlist_uri):
    ...
    new_playlist_tracks = ordered_playlist(playlist_data, playlist_final_features)
...
playlist_data = get_playlist_data(creator= 'annor999', playlist_uri='spotify:playlist:256bDWMdloMHhjzpORnjIp')
playlist_features = encode_fields(playlist_data)
playlist_clustered = MSclustering(playlist_features, playlist_data)
playlist_final_features = playlist_weighting(playlist_clustered)
new_playlist_tracks = ordered_playlist(playlist_data, playlist_final_features)
...
if __name__=="__main__":
    create_ordered_playlist('annor999', 'annor999', 'spotify:playlist:256bDWMdloMHhjzpORnjIp')
...
#chill
#spotify:playlist:6if17sVXsb6Zov9KOr4mcC
